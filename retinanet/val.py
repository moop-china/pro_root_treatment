...
def evaluate_scan(
    ...
    for score_index, all_detections in enumerate(detections_list):
        average_precisions = []
        ...
        ap_list['{}'.format(score_thresholds[score_index])] = ap

        sensitivity = true_positive / positive
        specificity = true_negative / negative
        youden_index = (sensitivity + specificity) - 1.

        youden_list['{}'.format(score_thresholds[score_index])] = youden_index
        sensitivity_list['{}'.format(score_thresholds[score_index])] = sensitivity
        specificity_list['{}'.format(score_thresholds[score_index])] = specificity
